...
int main() {
    ...
    int shm_send  = shm_open(SHM_P1, O_CREAT | O_RDWR, 0666);
    int shm_recv  = shm_open(SHM_P2, O_CREAT | O_RDWR, 0666);
    ...
    // Semaphores
    sem_t *sw = sem_open(SEM_P1_WRITE, O_CREAT, 0666, 1);
    sem_t *sr = sem_open(SEM_P1_READ,  O_CREAT, 0666, 0);

    sem_t *rw = sem_open(SEM_P2_WRITE, O_CREAT, 0666, 0);
    sem_t *rr = sem_open(SEM_P2_READ,  O_CREAT, 0666, 1);
